...
import org.springframework.data.rest.webmvc.support.UriToEntityDeserializer;
...
public @Data class Bar {
	...
	@Transient
	@JsonDeserialize(using=UriToEntityDeserializer.class)
	@JsonProperty(access=Access.WRITE_ONLY) 
	private Foo foo03;
	...
	//////////////////////////////////////////////////////////////////
	@Transient
	@JsonDeserialize(contentUsing=UriToEntityDeserializer.class)
	@JsonProperty(access=Access.WRITE_ONLY) 
