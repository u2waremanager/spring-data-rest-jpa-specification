...
//		domainSampleRepository.save(e3);
		...
		logger.info("-------------------------------------------");
		domainSampleManyRepository.findAll( (r, q, b) -> {return PredicateBuilder.of(r, q, b).build();} );
		logger.info("-------------------------------------------");
		domainSampleManyRepository.findAll( (r, q, b) -> {return PredicateBuilder.of(r, q, b).where().build();} );
		logger.info("-------------------------------------------");
		domainSampleManyRepository.findAll( (r, q, b) -> {return PredicateBuilder.of(r, q, b).where().and().eq("name", "a").build();} );
		logger.info("-------------------------------------------");
		domainSampleManyRepository.findAll( (r, q, b) -> {return PredicateBuilder.of(r, q, b).order().build();} );
		logger.info("-------------------------------------------");
		domainSampleManyRepository.findAll( (r, q, b) -> {return PredicateBuilder.of(r, q, b).order().desc("name").build();} );
